...
export default function Footer(){
    return (
        <Box w="100%" h="60%" pos={"absolute"}  zIndex={1000} bottom={"10%"} display="grid" alignItems={"flex-start"} p={20} >
                            <Box textAlign={"center"}><Link><Heading>JOIN OUR NEWSLETTER</Heading></Link></Box>
                            <Box>
                                <Flex w="50%" justifyContent={"space-around" } m="auto" fontSize={25} >
                            ...
                            <Box fontSize={19}><Box><Text>Name and address of the manufacturer:<br/>
